...
| 1 | A complete ranked game end to end on playcabal.pages.dev: seven issues across three subteams, Adjudicators, Couriers and Cartographers ([plan](docs/PLAN.md), [onboarding](docs/ONBOARDING.md)) | onboarding |
